...
const LoginModal = ({ isOpen, onClose, onRegisterClick }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/api/monitoring/auth/login`, {
                email,
                password
            });
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-fadeIn">
            <div className="max-w-md w-full relative bg-white p-8 sm:p-10 rounded-2xl shadow-2xl border border-slate-100">
                <button
                    onClick={onClose}
                ...
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-slate-600">
                        Sign in to your account to monitor your services.
                    </p>
                </div>
                ...
                <div className="text-center mt-8">
                    <p className="text-sm text-slate-600">
                        ...
                        <button onClick={onRegisterClick} className="font-bold text-emerald-600 hover:text-emerald-500 transition-colors">
                            Register here
                        </button>
                    </p>
                </div>
